...
import com.library.eth.Wallet;
import com.library.eth.WalletManager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fillContent(wallet.getAddress());
        fillContent(wallet.getPrivateKey());
        fillContent(wallet.getPublicKey());
